...
extension ZoomTransitionDelegate : UIViewControllerAnimatedTransitioning{
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        configureViews(for: preTransitionState, containerView: containerView, backgroundViewController: backgroundViewController!, viewsInBackground: (backgroundImageView!,backgroundImageView!), viewsInForeground:
            (foregroundImageView!,foregroundImageView!), snapshotViews: (imageViewSnapshot,imageViewSnapshot))
        ...
        UIView.animate(withDuration: duration, delay: 0, usingSpringWithDamping: 1.0, initialSpringVelocity: 0.0, options: [], animations: {
            self.configureViews(for: postTransitionState, containerView: containerView, backgroundViewController: backgroundViewController!, viewsInBackground: (backgroundImageView!,backgroundImageView!), viewsInForeground:
                (foregroundImageView!,foregroundImageView!), snapshotViews: (imageViewSnapshot,imageViewSnapshot))
        }) { (finished) in
            backgroundViewController?.view.transform = CGAffineTransform.identity
